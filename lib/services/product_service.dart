...
class ProductService extends ChangeNotifier {
  ...
  static List<ProductModel> _defaultProducts() => [
    ...
    ProductModel(
      id: '7',
      name: 'Unique Labels',
      description: 'High-end smoother product labels.',
      image: 'assets/products/bebe_unicorn_sticker.jpeg',
      price: 899,
      category: 'Labels',
    ),
    ProductModel(
      ...
      description: 'Top-class smoother product Stickers.',
      image: 'assets/products/boss.jpeg',
      price: 1499,
      category: 'Stickers',
    ),
    ProductModel(
      ...
      name: 'Gaming Labels',
      description: 'Top-class smoother product Stickers.',
      image: 'assets/products/car_wallpaper1.jpg',
      price: 1899,
      category: 'Stickers',
    ),
    ProductModel(
      ...
      name: 'Warning Labels',
      description: 'High-end smoother product labels.',
      image: 'assets/products/caution_sticker.png',
      price: 699,
      category: 'Labels',
    ),
    ProductModel(
      ...
      name: 'Unique Labels',
      description: 'High-end smoother product labels.',
      image: 'assets/products/metalic_foill.jpeg',
      price: 899,
      category: 'Labels',
    ),
    ProductModel(
      id: '12',
      name: 'Glass Caution Labels',
      description: 'Top Glass Caution labels.',
      image: 'assets/products/glass_caution.jpg',
      price: 1499,
      category: 'Labels',
    ),
    ProductModel(
      ...
      description: 'High Transparent labels.',
      image: 'assets/products/water.jpeg',
      price: 1550,
      category: 'Labels',
    ),
    ProductModel(
      ...
      description: 'High class Stickers.',
      image: 'assets/products/label3.jpeg',
      price: 699,
      category: 'Labels',
    ),
    ProductModel(
      id: '15',
      name: 'Danger Caution Stickers',
      description: 'Top Color Danger Caution Stickers.',
      image: 'assets/products/label4.jpeg',
      price: 499,
      category: 'Labels',
    ),
    ProductModel(
      ...
      name: 'Transparent Labels',
      description: 'High Transparent labels.',
      image: 'assets/products/transperant.jpeg',
      price: 699,
      category: 'Labels',
    ),
    ProductModel(
      ...
      name: 'Warning Labels',
      description: 'High-end smoother product labels.',
      image: 'assets/products/caution_stickers.jpg',
      price: 699,
      category: 'Labels',
    ),
    ProductModel(
      id: '18',
      name: 'Stamp Stickers',
      description: 'High-end smoother product Stickers.',
      image: 'assets/products/sticker2.jpeg',
      price: 699,
      category: 'Labels',
    ),
    ProductModel(
      ...
      name: 'Stamp Stickers',
      description: 'High-end smoother product Stickers.',
      image: 'assets/products/sticker3.jpeg',
      price: 699,
      category: 'Labels',
    ),
  ];
